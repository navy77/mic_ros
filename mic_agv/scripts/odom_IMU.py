...
#############################################################################
    ...
    #############################################################################
        ...
        self.ticks_meter_right = float(rospy.get_param('ticks_meter_right', 1698)) #The number of wheel encoder ticks per meter of travel
        self.base_width = float(rospy.get_param('~base_width', 0.485)) # The wheel base width in meters
        ...
        # subscriptions
        rospy.Subscriber("enc_1_value", Int32, self.lwheelCallback)
        rospy.Subscriber("enc_2_value", Int32, self.rwheelCallback)
        rospy.Subscriber("imu_value", Float64, self.imuCallback)
    ...
    #############################################################################
        ...
        if now > self.t_next:
            ...
            # th = self.prev_angZ * 0.0174532925 # convert to radian
            th = self.prev_angZ
